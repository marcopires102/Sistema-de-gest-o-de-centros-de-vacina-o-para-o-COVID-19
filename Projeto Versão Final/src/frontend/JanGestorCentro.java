...
public class JanGestorCentro extends javax.swing.JFrame {

    private Sistema sistema;
    private Serializacao dados;
    
    
    public JanGestorCentro(Sistema sistema, Serializacao dados) {
        initComponents();
        ...
        txtPosto.setText(Integer.toString(centro.getNPostosAtendimento()));
        txtMaxMarcacoes.setText(Integer.toString(centro.getNumMaxMarcacoes()));
    ...
    private void initComponents() {
        ...
        jLabel5.setText("N Posto Atendimento");

        jLabel6.setFont(new java.awt.Font("Segoe UI Semibold", 0, 14)); // NOI18N
        jLabel6.setText("N maximo marcações");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(98, 98, 98)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtMaxMarcacoes, javax.swing.GroupLayout.DEFAULT_SIZE, 202, Short.MAX_VALUE)
                            .addComponent(txtPosto)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        dispose();
        JanGestorCentroEditar janela = new JanGestorCentroEditar(sistema, dados);
        janela.setVisible(true);
